...
public class ExtentManager {
    ...
    public static synchronized ExtentReports getExtentReports() {
        if (extent == null) {
            ...
            spark.config().setDocumentTitle("Trendyol Automation Test Result");
            spark.config().setReportName("Trendyol Regression Test Suite");
            ...
            extent.setSystemInfo("Tester", "Ibrahim Agayev");
